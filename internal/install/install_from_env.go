...
type Env struct {
	...
	UploadUseAbsoluteUrl string `json:"upload_use_absolute_url"`
}
...
func loadEnv() (env *Env) {
	return &Env{
		...
		UploadUseAbsoluteUrl: os.Getenv("UPLOAD_USE_ABSOLUTE_URL"),
	}
}
...
func initBaseInfo(env *Env) (err error) {
	req := &InitBaseInfoReq{
		...
		UploadUseAbsoluteUrl: env.UploadUseAbsoluteUrl,
	}
