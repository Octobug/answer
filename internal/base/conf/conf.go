...
// Align with data that was generated by previous version of Answer
func makeConfigCompatible(c *AllConfig, config conf.Config) {
	if config.Get("service_config.upload_use_absolute_url") == nil {
		c.ServiceConfig.UploadUseAbsoluteUrl = true
	}
}
